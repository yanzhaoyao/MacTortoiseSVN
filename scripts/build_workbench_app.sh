...
HELPER_ENTITLEMENTS="$ROOT_DIR/Apps/MacSVNApp/HelperTool.entitlements"
...
/usr/bin/codesign --force --sign "$CODESIGN_IDENTITY" --generate-entitlement-der --entitlements "$HELPER_ENTITLEMENTS" "$APP_BUNDLE/Contents/Resources/bin/mtsvn-rs"
/usr/bin/codesign --force --sign "$CODESIGN_IDENTITY" --generate-entitlement-der --entitlements "$HELPER_ENTITLEMENTS" "$APP_BUNDLE/Contents/Resources/bin/MacSVNQuickActions"
/usr/bin/codesign --force --sign "$CODESIGN_IDENTITY" --generate-entitlement-der --entitlements "$HELPER_ENTITLEMENTS" "$XPC_BUNDLE/Contents/Resources/bin/mtsvn-rs"
